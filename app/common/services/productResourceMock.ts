namespace app.common {
    ...
    function mockRun($httpBackend: ng.IHttpBackendService) : void {
        var products: app.product.IProduct[] = [];

    }

    /*function mockRun($httpBackend: ng.IHttpBackendService) : void {
        var products: app.product.IProduct[] = [];
        var product: app.product.IProduct;
        product = new app.product.Product(1, "Leaf Rake", "GDN-0011", new Date(2009, 2, 19), 19.95,
            "Leaf rake with 48-inch wooden handle.",
            "http://openclipart.org/image/300px/svg_to_png/26215/Anonymous_Leaf_Rake.png");
        products.push(product);
        product = new app.product.Product(2, "Garden Cart", "GDN-0023", new Date(2010, 2, 18), 26.95,
            "15 gallon capacity rolling garden cart",
            "http://openclipart.org/image/300px/svg_to_png/58471/garden_cart.png");
        products.push(product);
        product = new app.product.Product(3, "Saw", "TBX-002", new Date(2002, 3, 1), 16.95,
            "15-inch steel blade hand saw",
            "http://openclipart.org/image/300px/svg_to_png/27070/egore911_saw.png");
        products.push(product);

        product = new app.product.Product(4, "Hammer", "TBX-0048", new Date(2013, 4, 21), 8.99,
            "Curved claw steel hammer",
            "http://openclipart.org/image/300px/svg_to_png/73/rejon_Hammer.png");
        products.push(product);

        product = new app.product.Product(5, "Video Game Controller", "GMG-0042", new Date(2012, 9, 25), 35.95,
